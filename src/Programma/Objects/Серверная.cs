...
namespace IIS.Programma
{
    ...
    public class Серверная : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Programma.Сотрудник fСотрудник;
        
        private IIS.Programma.DetailArrayOfКонтроллер fКонтроллер;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Programma.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Programma.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Programma.DetailArrayOfКонтроллер Контроллер
        {
            get
            {
                ...
                {
                    this.fКонтроллер = new IIS.Programma.DetailArrayOfКонтроллер(this);
                }
                IIS.Programma.DetailArrayOfКонтроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СервернаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяE", typeof(IIS.Programma.Серверная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СервернаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяL", typeof(IIS.Programma.Серверная));
                }
            }
        }
    }
