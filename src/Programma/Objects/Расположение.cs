    ...
    public class Расположение : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасположениеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасположениеE", typeof(IIS.Programma.Расположение));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасположениеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасположениеL", typeof(IIS.Programma.Расположение));
                }
            }
        }
    }
