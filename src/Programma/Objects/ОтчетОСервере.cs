...
namespace IIS.Programma
{
    ...
    [View("ОтчетОСервереE", new string[] {
            ...
            "Серверная.IDСерверной as \'ID Серверной\'",
            "Серверная.IP as \'IP\'",
            "Серверная.Порт as \'Порт\'",
            "Серверная.Протокол as \'Протокол\'",
            "Серверная.Сотрудник as \'Прикрепленный сотрудник\'",
            "Серверная.Сотрудник.IdСотрудника as \'ID сотрудника\'",
            "Серверная.Сотрудник.Фамилия as \'Фамилия Сотрудника\'"})]
