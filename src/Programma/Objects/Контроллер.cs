...
namespace IIS.Programma
{
    ...
    public class Контроллер : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Programma.Сенсоры fСенсоры;
        ...
        [PropertyStorage(new string[] {
                "Сенсоры"})]
        [NotNull()]
        public virtual IIS.Programma.Сенсоры Сенсоры
        {
            get
            {
                ...
                IIS.Programma.Сенсоры result = this.fСенсоры;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Programma.Серверная.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтроллерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтроллерE", typeof(IIS.Programma.Контроллер));
                }
            }
        }
    }
    ...
    public class DetailArrayOfКонтроллер : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Programma.DetailArrayOfКонтроллер members)

        // *** End programmer edit section *** (IIS.Programma.DetailArrayOfКонтроллер members)
        ...
        /// </summary>
        public DetailArrayOfКонтроллер(IIS.Programma.Серверная fСерверная) : 
                base(typeof(Контроллер), ((ICSSoft.STORMNET.DataObject)(fСерверная)))
        {
        }
        
        public IIS.Programma.Контроллер this[int index]
        {
            get
            {
                return ((IIS.Programma.Контроллер)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Programma.Контроллер dataobject)
        {
